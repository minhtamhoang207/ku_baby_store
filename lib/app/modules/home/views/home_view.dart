            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(
                      Assets.images.imgCarousel.path
                    )
                  )
                ),
              ),
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    children: [
                      _menuItem(title: 'Mẹ bầu', img: Assets.images.imgMom.path, color: AppColors.melon),
                      const SizedBox(width: 15),
                      _menuItem(title: 'Bé trai', img: Assets.images.imgBabyBoy.path, color: AppColors.lightBlue),
                      const SizedBox(width: 15),
                      _menuItem(title: 'Bé gái', img: Assets.images.imgBabyGirl.path, color: AppColors.lavender),
                      const SizedBox(width: 15),
                      _menuItem(title: 'Khác', img: Assets.images.imgOther.path, color: const Color(0xFF6FCF97)),
                    ],
                  ),
                ),
              ),
